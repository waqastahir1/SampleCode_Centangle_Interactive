...
{
    public partial class PayCitCitMonthlyVaultDuty
    {
        ...
        public string? XActivityDate { get; set; }
        public DateTime? DActivityDate { get; set; }
        public string? XStation { get; set; }
        public string? XStationDescription { get; set; }
        public decimal? XVaultAmount { get; set; }
