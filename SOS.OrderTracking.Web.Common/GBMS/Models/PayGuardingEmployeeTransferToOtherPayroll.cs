...
{
    public partial class PayGuardingEmployeeTransferToOtherPayroll
    {
        ...
        public string XDestinationPayroll { get; set; } = null!;
        public string? XDestinationPayrollDescription { get; set; }
